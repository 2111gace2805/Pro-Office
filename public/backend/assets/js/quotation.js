...
(function ($) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var product_row = `<tr id="product-${item['id']}">
                                            ...
                                            <td class="delivery-time"><input type="text" name="delivery_time[]" class="form-control input-delivery-time" value="${product['delivery_time'] != null ? product['delivery_time'] : ''}"></td>
    ...
    $(document).on('keyup change', '.input-quantity, .input-unit-cost, .input-discount', function () {
        ...
        taxSelected($(line).find('select.input-tax'));
    });
