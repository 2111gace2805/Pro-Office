	    ...
	    $.ajax({
	        ...
	        success: function(data) {
	            ...
	            var product_row = `<tr id="product-${item['id']}">
											...
											<td class="text-right tax"><select class="form-control selectpicker input-tax selectIva" name="tax[${item['id']}][]" title="${$lang_select_tax}" multiple="true">${tax_selector}</select></td>
