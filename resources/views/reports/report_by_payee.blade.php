    ...
    <div class="col-md-12">
        <div class="card panel-default">
            <div class="card-header">
                <h4 class="header-title">{{ _lang('Report By Payee') }}</h4>
            </div>

            <div class="card-body">

                <div class="report-params">
                    <form class="validate" method="post" action="{{ route('reports.report_by_payee','view') }}">
                        <div class="row">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-3">
                                <button type="submit"
                                    class="btn btn-primary btn-smk">{{ _lang('View Report') }}</button>
                            </div>
                    </form>
