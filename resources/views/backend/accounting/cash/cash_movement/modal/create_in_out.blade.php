<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('cash_movement.store') }}"
    ...
    <div class="row p-2">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" name="cashmov_type" id="cashmov_type" required>
                    <option value="In" @if(old('cashmov_type')== 'In') selected @endif>{{ _lang('In') }}</option>
                    <option value="Out" @if(old('cashmov_type')== 'Out') selected @endif>{{ _lang('Out') }}</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="cashmov_concept" value="{{ old('cashmov_concept') }}" required>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="cashmov_value" value="{{ old('cashmov_value') }}" required>
            </div>
        </div>
