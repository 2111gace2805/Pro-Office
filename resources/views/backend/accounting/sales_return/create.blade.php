    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">{{ _lang('Devolución por garantía') }}</h4>
            </div>

            <div class="card-body">
                <form method="post" id="formReturn" class="validate" autocomplete="off"
                    action="{{ action('SalesReturnController@store', ['invoice_id'=>$id]) }}" enctype="multipart/form-data">
                    {{ csrf_field()}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" style="pointer-events:none;">
                                ...
                                <select readonly class="form-control" name="tipodoc_id" id="tipodoc_id" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">{{ _lang('Fecha de devolución') }}</label>
                                <input type="date" class="form-control" name="invoice_date" value="{{ $invoiceDate }}" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4" style="pointer-events:none;">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="modfact_id" id="modfact_id" readonly>
                                    <option value="">{{ _lang('Select one') }}</option>
                        ...
                        <div class="col-12 col-md-8" style="pointer-events:none;">
                            <div class="form-group">
                                ...
                                <select readonly class="form-control select2-ajax" data-value="id" data-display="company_name" data-display2="nrc" data-display2label="NRC"
                        ...
                        <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" name="nombre_comercial" id="nombre_comercial"
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="col-12 col-md-4" style="pointer-events:none;">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Tipo de documento') }}</label>
                                    <select readonly class="form-control" name="tdocrec_id" id="tdocrec_id">
                                    <option value="">{{ _lang('Select One') }}</option>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="num_documento" id="num_documento"
                            ...
                            <div class="col-12 col-md-4" style="pointer-events:none;">
                                <div class="form-group">
                                    ...
                                    <select readonly class="form-control" name="plazo_id" id="plazo_id_invoice">
                                      <option value="">{{ _lang('Select One') }}</option>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="periodo" id="periodo"
                        ...
                        <div class="collapse multi-collapse row" style="width: 100%; padding-left: 15px;" id="clientFields">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="telefono" id="telefono"
                                    value="{{ old('telefono') }}">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="correo" id="correo"
                                    value="{{ old('correo') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="complemento" id="complemento"
                            ...
                            <div class="col-12 row p-0 m-0">
                                <div class="col">
                                     <div class="form-group" style="pointer-events:none;">
                                        ...
                                        <select readonly class="form-control select2" name="actie_id" id="actie_id_invoice">
                                        <option value="">{{ _lang('Select One') }}</option>
                                ...
                                <div class="col">
                                     <div class="form-group">
                                          ...
                                          <input readonly type="text" class="form-control" name="desc_actividad" id="desc_actividad" value="{{ old('desc_actividad', $invoice->desc_actividad) }}">
                                        </div>
                                  </div>
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                                <div class="form-group" style="pointer-events:none;">
                                    ...
                                    <select readonly class="form-control" name="refisc_id" id="refisc_id">
                                    <option value="">{{ _lang('Select One') }}</option>
                        ...
                        <div class="col-12 col-md-8">
                                <div class="form-group" style="pointer-events:none;">
                                    ...
                                    <select readonly class="form-control select2" name="regi_id" id="regi_id">
                                    <option value="">{{ _lang('Select One') }}</option>
                        ...
                        <div class="col-md-12">
                            <fieldset>
                                <legend style="font-size: 1rem;"><b>Solicitante de devolución:</b></legend>
                            </fieldset>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control parsley-success" name="tipo_doc_soli" id="tipo_doc_soli" onchange="validoDatos(this)" required="">
                                    <option value="">Seleccione uno</option>
                                    <option value="36">NIT</option><option value="13">DUI</option><option value="37">Otro</option><option value="03">Pasaporte</option><option value="02">Carnet De Residente </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="alert alert-success w-100 mx-3 mt-2 mb-4" role="alert">* Modifique la lista de ítems dejando únicamente los que están en mal estado y que NO DEBEN SER REINTEGRADOS al stock.
                        <br>
                        * La factura pasará a "Anulada". Considere crear una nueva factura con los nuevos ítems.
                        <br>
                        * En este listado aparecen únicamente los ítems que su plazo de garantía aún no ha vencido de acuerdo al plazo configurado en el catálogo de productos.</div>
								...
								<table id="order-table" class="table table-bordered">
									...
									<tbody>
										@foreach($invoice->invoice_items as $key=>$item)
                                            ...
                                            @php
                                                $date = new \DateTime($invoice->raw_invoice_date());
                                                $today = new \DateTime();

                                                $days = $today->diff($date)->format('%d');
                                                $months = $today->diff($date)->format('%m');
                                                $years = $today->diff($date)->format('%y');

                                                $shouldContinue = false;
                                                switch ($item->item->product->warranty_type) {
                                                    case 'Days':
                                                        if($days > $item->item->product->warranty_value){
                                                            $shouldContinue = true;
                                                        }
                                                        break;
                                                    case 'Months':
                                                        if($months > $item->item->product->warranty_value){
                                                            $shouldContinue = true;
                                                        }
                                                        break;
                                                    case 'Years':
                                                ...
                                                $stock = $item->item->product_stock->where('company_id', company_id())->first()->quantity??0;
                                            @endphp
											<tr id="product-{{ $item->item_id }}">
                                                ...
                                                <td class="input-product-code" title="Producto original: {{$item->item->product->original}}  -  Garantía: {{ $item->item->product->warranty_value.' '._lang($item->item->product->warranty_type) }}">{{ $item->item->product->product_code }}</td>
                                                ...
                                                <input type="hidden" name="invoice_item_id[]" class="input-invoice_item_id" value="{{$item->id}}">
											</tr>
										@endforeach
									</tbody>
                        ...
                        <div class="form-check ml-3 mb-3 d-none">
                            <input class="form-check-input" name="anular_factura" id="anular_factura" type="checkbox" value="1" id="flexCheckChecked" checked />
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="button" onclick="saveReturn(event)" class="btn btn-primary btn-lg"><i class="ti-save-alt"></i> {{ _lang('Registrar devolución') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
