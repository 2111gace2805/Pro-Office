    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">{{ _lang('Add New Supplier') }}</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group-city">
                            <div class="form-group">
                                ...
                                <select class="form-control select2-ajax" data-value="munidepa_id"
                                    data-display="muni_nombre" data-table="municipios" name="city" id="munidepa_id"
                                    data-where_extra="depa_id = '-1'">
                                    <option value="">{{ _lang('Select One') }}</option>
                                    {{ create_option("municipios", "munidepa_id", "muni_nombre", old('munidepa_id'),
                                    ['munidepa_id=' => old('munidepa_id')]) }}
                                </select>
                            </div>
                        </div>
