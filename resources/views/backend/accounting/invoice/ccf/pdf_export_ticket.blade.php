...
<body style="color: #636363; padding-left:10px; padding-right:10px; padding-top:10px">
    ...
    {{-- <div><b>No. Ticket: <div style="display:inline-block;width: 5px"></div> {{ $invoice->ticket_number }}</b></div>
    <div><b>Fecha:      <div style="display:inline-block;width: 28px"></div> {{ $invoice->invoice_date }}</b></div>
    <div><b>Hora:       <div style="display:inline-block;width: 28px"></div> {{ $invoice->invoice_time}} </b></div>
    <div><b>Cliente:    <div style="display:inline-block;width: 23px"></div> {{ $invoice->client->contact_name }}</b></div>
    <div><b>Dirección:  <div style="display:inline-block;width: 9px"></div> {{ $invoice->client->address??'' }}</b></div> --}}
    <table>
        <tr>
            <td><b>No. Ticket:</b></td>
