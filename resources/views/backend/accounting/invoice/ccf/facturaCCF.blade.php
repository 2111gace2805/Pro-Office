    ...
    <table class="container" style="margin: 0; padding: 0;">
        <tr>
            <td>
                ...
                {{-- <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td class="borders" style="width: 64.2%; padding: 5px;border-top:0;border-right:0;">
                            <table style="width: 100%;border-collapse: collapse;">
                                <tr>
                                    <td style="width: 45%;">{{ _lang('It is') }} {{ dollarToText($invoice->grand_total) }}</td>
                                </tr>
                                <tr>
                                    <td>NOTA: {{ ( $invoice->note != '' ) ? $invoice->note : '' }}</td>
                                </tr>
                            </table>
                        </td>
                        <td  style="width: 35.8%; padding: 0px; margin: 0px;">
                            <table style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td class="borders center" style="width: 8%;border-top:0">SUMAS</td>
                                    <td class="borders right" style="width: 8%;border-top:0">{{ decimalPlace($noSujetoSum, $currency) }}</td>
                                    <td class="borders right" style="width: 8%;border-top:0">{{ decimalPlace($exentoSum, $currency) }}</td>
                                    <td class="borders right" style="width: 8%;border-top:0">{{ decimalPlace($gravadoSum, $currency) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="borders left" style="width: 8%;">13 % IVA</td>
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($invoice->tax_total, $currency) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="borders left" style="width: 8%;">Sub-Total</td>
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($gravadoSum + $invoice->tax_total, $currency) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="borders left" style="width: 8%;">(-) IVA Retenido</td>
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($invoice->iva_retenido, $currency) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="borders left" style="width: 8%;">Vtas. No sujetas</td>
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($noSujetoSum, $currency) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="borders left" style="width: 8%;">Vtas. Extentas</td>
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($exentoSum, $currency) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="borders left" style="width: 8%;">Total</td>
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($invoice->grand_total, $currency) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
