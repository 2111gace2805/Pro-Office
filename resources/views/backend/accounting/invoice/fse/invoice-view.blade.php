...
<div id="invoice-view" style="height:100%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="font-weight: bold;width:auto;" class="text-center">
                        ...
                        <div style="font-size: 14px">FACTURA SUJETO EXCLUIDO</div>
                    </td>
    ...
    <table class="classic-table" style="font-size: 15px; height:80%" id="invoice-item-table">
        <thead>
            <tr>
                <th style="border-top: 0px solid #565656; border-left: 0px solid #565656; border-radius: 5px !important;padding: 0px;">
                    <div
                ...
                <th style="border-top: 0px solid #565656; border-right: 0; border-left: 0px solid #565656; border-radius: 5px !important; padding: 0px;">
                    <div
                        style="border-top: 1px solid #565656; border-radius: 0px 10px 1px 0px; height: 100%; width: 100%; margin: 0; border-right: 2px solid #565656; border-left: 2px solid #565656; margin-top: 0px; margin-left: -1px; box-sizing: content-box; border-bottom: 2px solid #565656;" class="d-flex justify-content-center align-items-center text-center">
                        {{ _lang('Ventas') }}
                    </div>
                </th>
            </tr>
        ...
        <tbody id="invoice">
            @for ($i = 0; $i < count($invoice->invoice_items); $i++)
                ...
                <tr id="product-{{ $invoice->invoice_items[$i]->item_id }}">
                    ...
                    <td style="border-left: 2px solid #565656; border-right: 0px solid #565656; border-bottom: 0px solid #565656; border-top: 0px solid #565656;"
                        class="text-center pb-0">{{ decimalPlace($invoice->invoice_items[$i]->unit_cost, $currency) }}</td>
            ...
            <tr>
                ...
                <td class="p-1 text-right" colspan="2" style="border-top: 2px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0px solid #565656; border-radius: 5px !important; padding: 0px;">Sumatoria de ventas:
                </td>
            ...
            <tr>
                ...
                <td class="p-1 text-right" colspan="2" style="border-top: 2px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0px solid #565656; border-radius: 5px !important; padding: 0px;">Monto global Desc., Rebajas y otros a ventas:
                </td>
                <td class="p-1 text-right" style="border-top: 2px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important; padding: 0px;">
            ...
            <tr>
                ...
                <td style="border-top: 2px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important;" colspan="2" class="text-right">Sub-Total</td>
                <td style="border-top: 0px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important;" class="text-right">{{ decimalPlace($gravadoSum-$invoice->iva_retenido, $currency) }}</td>
            </tr>
            <tr>
                ...
                <td style="border-top: 2px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;" colspan="2" class="pl-1 text-right">IVA Retenido:</td>
                <td style="border-top: 0px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important; padding: 0px;" class="text-right p-1">{{ decimalPlace($invoice->iva_retenido, $currency) }}</td>
            </tr>
            <tr>
                <td colspan="3" style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;"
                    class="">
                </td>
                <td style="border-top: 2px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;" colspan="2" class="pl-1 text-right">Retención Renta:</td>
                <td style="border-top: 0px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important; padding: 0px;" class="p-1 text-right">{{ decimalPlace(0.0, $currency) }}</td>
            </tr>
            <tr>
                <td colspan="3" rowspan="2" style="border-top: 0px solid #565656;border-right: 0;border-left: 0px solid #565656;border-bottom: 0px solid #565656;border-radius: 5px !important; padding: 0px;"
                    class="">
                    <div style="height: 100%; width: 100%; border-bottom: 2px solid #565656; border-left: 2px solid #565656; border-radius: 0px 0 0px 10px; border-top: 0; margin-left: -1px; margin-top: -1px; box-sizing: content-box;">
                    </div>
                </td>
            </tr>
            <tr>
                <td style="border-top: 2px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important; padding: 0px;" colspan="2" class="pl-1 text-right">Total a Pagar:</td>
                <td style="border-top: 0px solid #565656; border-left: 2px solid #565656; border-radius: 5px !important; padding: 0px; border-bottom: 0px; border-right: 0px;"
                    class="">
                    <div
                        style="height: 100%; width: 100%; border-bottom: 2px solid #565656; border-right: 2px solid #565656; border-radius: 0px 0 10px 0px; border-top: 0; border-left: 0; margin-left: -1px; margin-top: -1px; box-sizing: content-box;" class="d-flex justify-content-end align-items-center">
