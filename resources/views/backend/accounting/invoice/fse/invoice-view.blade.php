    ...
    <table class="classic-table" style="font-size: 15px; height:80%" id="invoice-item-table">
        ...
        <tbody id="invoice">
            ...
            <tr>
                ...
                <td style="border-top: 0px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important; padding: 0px;" class="p-1 text-right">{{ decimalPlace($invoice->retencion_renta, $currency) }}</td>
            </tr>
            <tr>
