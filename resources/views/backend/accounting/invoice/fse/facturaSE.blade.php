...
<body style="margin: 0; padding: 0; {{ $style }}">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td class="center" style="width: 50%; font-weight: bold;">
                    ...
                    <div>FACTURA SUJETO EXCLUIDO</div>
                    <br>
    ...
    <table style="width: 100%;margin:0;">
        <tr>
            ...
            <td style="width: 50%; padding: 5px;">
                ...
                <div style="border: 2px solid #565656; border-radius: 10px; padding: 10px;min-height:100px;">
    ...
    <table class="borders" style="width: 100%;border-collapse: collapse;border-top:0;">
        <tr>
            <td style="width: 55.2%;">{{ _lang('It is') }} {{ dollarToText($invoice->grand_total) }} DÓLARES</td>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr class="borders" style="border-top:0;">
            ...
            <td style="width: 33.2%;">{!! nl2br($invoice->note) !!} </td>
