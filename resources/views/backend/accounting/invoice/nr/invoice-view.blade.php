...
<div id="invoice-view" style="height:100%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="font-weight: bold;width:auto;" class="text-center">
                        ...
                        <div style="font-size: 14px">NOTA DE REMISIÓN</div>
                    </td>
    ...
    <div class="row_">
        ...
        <div style="border: 2px solid #565656; border-radius: 10px;width:50% !important;" class="table-responsive col-md6" >
            <table class="classic-table" style="font-size: 15px">
                ...
                <tr>
                    <td class="font-weight-bold pl-2">{{ _lang('Nombre Comercial:') }}</td>
                    <td class="">{{ get_option('tradename') }}</td>
                </tr>
                <tr>
        ...
        <div style="border: 2px solid #565656; border-radius: 10px;width:50% !important;" class="table-responsive col-md6">
            <table class="classic-table" style="font-size: 15px">
                ...
                <tr>
                    <td class="font-weight-bold pl-2">{{ _lang('Nombre Comercial:') }}</td>
                    <td class="">{{ $invoice->name_invoice }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <table class="classic-table" style="font-size: 15px; height:80%" id="invoice-item-table">
        ...
        <tbody id="invoice">
            ...
            <tr>
                <td colspan="3" style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0px solid #565656; border-radius: 5px !important; padding: 0px;"
                    class="text-center">
                </td>
                <td style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;" colspan="2">Vtas. No sujetas</td>
                <td style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;"></td>
                <td style="border-top: 0px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 2px solid #565656; border-radius: 5px !important; padding: 0px;" class="text-right pr-1">{{decimalPlace($noSujetoSum, $currency)}}</td>
            </tr>
            <tr>
                ...
                <td style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;" colspan="2">Vtas. Exentas</td>
                <td style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;"></td>
