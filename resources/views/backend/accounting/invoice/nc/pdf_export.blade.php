            ...
            <td>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="center" style="width: 50%; font-weight: bold;">
                                ...
                                <div>{{ mb_strtoupper($invoice->tipo_documento->tipodoc_nombre, 'UTF-8') }}</div>
                                <br>
                ...
                <table style="width: 100%;border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            <th class="item borders right" style="width: 8%;">Precio Unitario</th>
                ...
                <table class="borders" style="width: 100%;border-collapse: collapse;border-top:0;">
                    <tr>
                        ...
                        <td class="center" style="width: 8.9%;border-left: 2px solid #565656;">SUMAS</td>
                        <td class="center" style="width: 8.9%;border-left: 2px solid #565656;">{{ decimalPlace($noSujetoSum, $currency) }}</td>
                        <td class="center" style="width: 8.9%;border-left: 2px solid #565656;">{{ decimalPlace($exentoSum, $currency) }}</td>
