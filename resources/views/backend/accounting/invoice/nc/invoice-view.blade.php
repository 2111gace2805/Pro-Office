    ...
    <table class="classic-table" style="font-size: 15px; margin-top:10px;" id="invoice-item-table">
        ...
        <tbody id="invoice">
            ...
            <tr>
                ...
                <td style="border-top: 0px solid #565656; border-right: 0; border-left: 2px solid #565656; border-bottom: 0; border-radius: 5px !important; padding: 0px;"></td>
                <td style="border-top: 0px solid #565656; border-right: 2px solid #565656; border-left: 2px solid #565656; border-bottom: 1px solid #565656 !important; border-radius: 5px !important; padding: 0px;" class="text-right">{{ decimalPlace($invoice->retencion_renta, $currency) }}&nbsp;</td>
            </tr>
            <tr>
