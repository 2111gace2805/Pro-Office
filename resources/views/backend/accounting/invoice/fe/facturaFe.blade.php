                            ...
                            <div style="border: 2px solid #565656; border-radius: 10px;min-height:155px;">
                                <table style="width: 100%;">
                                    ...
                                    @if( $invoice->tdocrec_id != '' )
                                        <tr>
                                            <td>{{ _lang('Tipo de documento:') }}</td>
                                            <td>{{ $tipoDoc }}</td>
                                        </tr>
                                        <tr>
                                            <td>{{ _lang('Número de documento:') }}</td>
                                    ...
                                    @else
                                        ...
                                        @endfor
                                    @endif
                                    @if( $invoice->client->descActividad != '')
                                        <tr>
                                            <td>{{ _lang('Actividad económica:') }}</td>
                        ...
                        <td  style="width: 35.8%; padding: 0px; margin: 0px;">
                            <table style="width: 100%; border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td class="borders right" style="width: 8%;">{{ decimalPlace($gravadoSum-$invoice->iva_retenido, $currency) }}</td>
                                </tr>
                                <tr>
