    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">Agregar Productos/Servicios</h4>
            </div>

            <div class="card-body">
                <div class="alert alert-primary" role="alert">
                    Desde este apartado puede realizar la carga inicial de su inventario. Puede cargar los servicios y productos agregandolos a la plantilla brindada previamente según el formato indicado.
                </div>
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12">
                        <div class="card shadow-none" style="border:1px solid #e0e0e0;">
                            <div class="card-body">
                                ...
                                <input type="file" class="form-control dropify" name="products_excel" id="products_excel" data-allowed-file-extensions="xlsx xls">
                            </div>
                        </div>
                    </div>
