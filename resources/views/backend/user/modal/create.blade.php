    ...
    <div class="row p-2">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <a href="{{ route('roles.create') }}" data-reload="false"
                    data-title="{{ _lang('Add User Role') }}" class="ajax-modal-2 select2-add"><i
                ...
                <select class="form-control select2-ajax" data-value="id" data-display="name"
                    data-table="staff_roles"  name="role_id">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="dui" value="{{ old('dui') }}" placeholder="00000000-0" required>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="seller_code" value="{{ old('seller_code') }}" maxlength="30">
            </div>
        </div>
