...
$language["Transfers"]="Transfers";
$language["Tranfers"]="Tranfers";
$language["Transfer Code"]="Transfer Code";
$language["Transfer Date"]="Transfer Date";
$language["Transfers List"]="Transfers List";
$language["Departure date"]="Departure date";
$language["Transfers Received"]="Transfers Received";
$language["Import number"]="Import number";
$language["Product Code"]="Product Code";
$language["Weight"]="Weight (kg)";
$language["Comment"]="Comment";
$language["Import quote"]="Import quote";
$language["Export to Excel"]="Export to Excel";
$language["Download template"]="Download template";
$language["Drag and drop a file"]="Drag and drop a file here or click here";
$language["Delivery time"]="Delivery time";
$language["Immediate"] = "Immediate";
$language["Minor stock"] = " available";
$language["Empty stock"] = "Empty stock";
$language["View Export Invoice"] = "View Export Invoice";
$language["Export on account of"] = "Sale on account of";
$language["Business line"] = "Business line";
$language["Condition"] = "Condition";
$language["Affected sales"] = "Affected sales";
$language["It is"] = "It is";
$language["Print or download"]="Print or download";
$language["FEX"] = "Export bill";
$language["CCF"] = "Proof of tax credit";
$language["FAC"] = "Final consumer invoice";
$language["Not found"] = "Not found";